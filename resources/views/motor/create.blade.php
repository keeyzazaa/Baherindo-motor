  ...
  <form action="{{ route('motor.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-10 rounded-3xl shadow-md w-full max-w-md">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
      <div>
        ...
        <input type="text" id="nama_motor" name="nama_motor" class="mt-1 block w-full p-2 border border-gray-300 rounded-3xl" required>
      </div>

      <div>
        <label for="harga" class="block text-sm font-medium text-gray-700">Harga Motor</label>
        <input type="text" id="harga_motor" name="harga_motor" class="mt-1 block w-full p-2 border border-gray-300 rounded-3xl" required>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
      <div>
        ...
        <input type="text" id="tahun_motor" name="tahun_motor" class="mt-1 block w-full p-2 border border-gray-300 rounded-3xl" required>
      </div>

      <div>
        <label for="km" class="block text-sm font-medium text-gray-700">Kilometer</label>
        <input type="text" id="km_motor" name="km_motor" class="mt-1 block w-full p-2 border border-gray-300 rounded-3xl" required>
      </div>
    </div>
